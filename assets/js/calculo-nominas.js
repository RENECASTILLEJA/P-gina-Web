...
$(function() {
    $(".en").click(function() {
       ...
       // $(".language-selected").text("English");
        ...
        $(".about-container ul:nth-child(2) li:nth-child(3) a").text("Terms and Policies");
  //informacion
  $(".imagen11").text("Nuestros Servissscios");
  //NuestrosServiciosone
  $(".imagen12").text("Nuestros ssss");
  //NuestrosServiciosone
  //NuestrosServiciosone
  $(".calculonominas1").text("Nuestsssros Servicios");
  //NuestrosServiciosone
  $(".calculonominas2").text("Nuessssstros Servicios");
  //NuestrosServiciosone
  $(".calculonominas3").text("Nuessstros Servicios");
  //NuestrosServiciosone
  $(".calculonominas4").text("Nuestaadssros Servicios");
  //NuestrosServiciosone
  $(".calculonominas5").text("Nuesfgtros Servicios");
  //NuestrosServiciosone
  $(".calculonominas6").text("Nuesgtros Servicios");
  //NuestrosServiciosone
  $(".calculonominas7").text("Nuesgtros Servicios");
  //NuestrosServiciosone
  $(".calculonominas8").text("Nuesgtros Servicios");
  //NuestrosServiciosone
  $(".calculonominas9").text("Nueshtros Servicios");
  //NuestrosServiciosoneh
  $(".problemas1").text("55 Servicios");
  //NuestrosServiciosone6
  $(".problemas2").text("22 Servicios");
  //NuestrosServiciosone
  $(".problemas3").text("1 Servicios");
  //NuestrosServiciosone
...
//boton
$(".Sobre").text("Dirección");
      
//boton
$(".Contacto").text("Sobre Nosotros");
//boton
...
$(function() {
    $(".es").click(function() {
       ...
       // $(".language-selected").text("Español");
        ...
        //informacion
        $(".imagen11").text("Nuestros Servicios");
        //NuestrosServiciosone
        $(".imagen12").text("Nuestros Servicios");
        //NuestrosServiciosone
        //NuestrosServiciosone
        $(".calculonominas1").text("Nuestros Servicios");
        //NuestrosServiciosone
        $(".calculonominas2").text("Nuestros Servicios");
        //NuestrosServiciosone
        $(".calculonominas3").text("Nuestros Servicios");
        //NuestrosServiciosone
        $(".calculonominas4").text("Nuestros Servicios");
        //NuestrosServiciosone
        $(".calculonominas5").text("Nuestros Servicios");
        //NuestrosServiciosone
        $(".calculonominas6").text("Nuestros Servicios");
        //NuestrosServiciosone
        $(".calculonominas7").text("Nuestros Servicios");
        //NuestrosServiciosone
        $(".calculonominas8").text("Nuestros Servicios");
        //NuestrosServiciosone
        $(".calculonominas9").text("Nuestros Servicios");
        //NuestrosServiciosone
        $(".problemas1").text("Nuestros Servicios");
        //NuestrosServiciosone
        $(".problemas2").text("Nuestros Servicios");
        //NuestrosServiciosone
        $(".problemas3").text("Nuestros Servicios");
        //NuestrosServiciosone
});
});